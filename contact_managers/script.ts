...
function copyText(text: string, element: HTMLElement)
{
...
function displayAllContacts(contactArray: Contact[]) {
...
let contact_list: HTMLUListElement;
let add_btn: HTMLButtonElement;
let name_input: HTMLInputElement;
let email_input: HTMLInputElement;
let phone_input: HTMLInputElement;
let save_btn: HTMLButtonElement;
let contact_form: HTMLDivElement;
let search_input: HTMLInputElement;

function init() {
	contact_list = document.querySelector("#contact-items") as HTMLUListElement;
	add_btn = document.querySelector("#add-btn") as HTMLButtonElement;
	name_input = document.querySelector("#name-input") as HTMLInputElement;
	email_input = document.querySelector("#email-input") as HTMLInputElement;
	phone_input = document.querySelector("#phone-input") as HTMLInputElement;
	save_btn = document.querySelector("#save-btn") as HTMLButtonElement;
	contact_form = document.querySelector("#contact-form") as HTMLDivElement;
	search_input = document.querySelector("#search-input") as HTMLInputElement;

...
btn_send_register?.addEventListener('click', () => {
    ...
    const input_register_confirm = (document.getElementById('input-register-confirm-password') as HTMLInputElement).value;

    if (input_register_password !== input_register_confirm) {
        alert('Not the same password');
        (document.getElementById('input-register-password') as HTMLInputElement).value = '';
        (document.getElementById('input-register-confirm-password') as HTMLInputElement).value = '';
        return;
    }
    ...
    if (registerUser(input_register_login, input_register_password)) {
        ...
        (document.getElementById('input-register-login') as HTMLInputElement).focus();
        (document.getElementById('input-register-password') as HTMLInputElement).value = '';
        (document.getElementById('input-register-confirm-password') as HTMLInputElement).value = '';
    }
})